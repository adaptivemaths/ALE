...
class HomePage extends React.Component {
  ...
  render() {
    // If userId has been set then redirect to profile page
      ...
      <div className="homepage">
        ...
        <div className="info">
          ...
          <div className="small-info">
            Our assessment platform learns your ability, creates questions that
            target your growth areas and provides personalised learning
            recommendations
          </div>
        </div>
